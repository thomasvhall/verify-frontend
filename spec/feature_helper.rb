...
module FeatureHelper
  ...
  def set_stub_federation_in_session(idp_entity_id = 'http://idcorp.com')
    idps = [
        { 'simple_id' => 'stub-idp-one', 'entity_id' => idp_entity_id },
        { 'simple_id' => 'stub-idp-two', 'entity_id' => 'other-entity-id' }, #TODO do we need stub-idp-two, stub-idp-three, stub-idp-demo?
        { 'simple_id' => 'stub-idp-three', 'entity_id' => 'a-different-entity-id' },
        { 'simple_id' => 'stub-idp-demo', 'entity_id' => 'demo-entity-id' }
    ]
